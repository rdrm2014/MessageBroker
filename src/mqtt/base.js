...
module.exports = function (client) {
    ...
    client.on('message', function(topic, dataJSON) {
        ...
        client.publish('rules', JSON.stringify(services.convertNodeRedtoXML(json)));
        ...
        //
        //var rhsElem = ruleElem.ele('rhs', {}, rhs);
        //
        //var xmlString = xml.end({ pretty: true});
        //console.log(xmlString);
        //
        //client.publish('rules', JSON.stringify({name: ruleName, rule: xmlString}));
        //
        ///**/
        //
        ...
        //"end";
        //
        //client.publish('rulesDRL', JSON.stringify({name: ruleName, rule: resultDRL}));
